package org.example.newalertmessaging.userService.config.security.filterChain;

import jakarta.servlet.FilterChain;
import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import org.example.newalertmessaging.userService.component.Token.provider.JWTProvider;
import org.example.newalertmessaging.userService.component.Token.provider.JWTProviderImpl;
import org.example.newalertmessaging.userService.config.security.SecurityConfig;
import org.example.newalertmessaging.userService.exception.auth.Cookie.CookieNotFoundException;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if(!urlFromNotNeedAuthentication) {
            System.out.println("not public url");
